...
exports.config = {
    ...
    //
    maxInstances: staticConfig.maxInstances,
    //
    ...
    capabilities: [{
        ...
        maxInstances: 5,
        //
        browserName: staticConfig.browser,
        'goog:chromeOptions': staticConfig.chromeOptions,
    ...
    waitforTimeout: staticConfig.timeout,
    //
    ...
    before: function (capabilities, specs) {
        ...
        browser.addCommand("waitAndClick", () => {
            try {
                ...
                throw new Error(`Could not click on selector : ${this}`)
            }
        }, true)
    },
    /**
